...
import { type UseQueryOptions, type UseQueryResult } from "./types"
...
describe("useQueries", () => {
  ...
  //           <button onClick={async () => await result[0].refetch()}>refetch</button>
  //         </div>
  //       )
  //     }
  ...
  //       expectTypeOf<QueryObserverResult<string[], boolean>>(result1[2])
  //       expectTypeOf<number | undefined>(result1[0].data)
  //       expectTypeOf<string | undefined>(result1[1].data)
  //       expectTypeOf<string[] | undefined>(result1[2].data)
  ...
  //     interface BizError { code: number }
  ...
  //           {
  //             queryKey: key1,
  //             queryFn: async () => await Promise.resolve('string'),
  //           },
  //         ],
  //       })
  ...
  //           queryKey: ['key', i] as const,
  //           queryFn: async () =>
  //             await fetch('return Promise<any>').then(async (resp) => await resp.json()),
  //         })),
  //       })
  ...
  //               queryKey: key,
  //               queryFn: fn
  //                 ? async (ctx: QueryFunctionContext<TQueryKey>) => {
  //                     expectTypeOf<TQueryKey>(ctx.queryKey)
  //                     return await fn.call({}, ctx)
  //                   }
  //                 : undefined,
  //             }
  //           },
  ...
  //           {
  //             queryKey: key2,
  //             queryFn: async () => await Promise.reject(new Error('single query error')),
  //             throwOnError: true,
  //             retry: false,
  //           },
  //           {
  ...
  //     const key = queryKey()
  //     const queryFn = async () => {
  //       return await Promise.resolve('custom client')
  //     }
  ...
  //             {
  //               queryKey: key1,
  //               queryFn: async () => await Promise.resolve('first result'),
  //             },
  //             {
  //               queryKey: key2,
  //               queryFn: async () => await Promise.resolve('second result'),
  //             },
  //           ],
  //           combine: (results) => {
  //             return {
  ...
  //             queryFn: async () => {
  //               await sleep(5)
  //               return await Promise.resolve('query1')
  //             },
  //           },
  //           {
  //             queryKey: key2,
  //             queryFn: async () => {
  //               await sleep(20)
  //               return await Promise.resolve('query2')
  //             },
  //           },
  //         ],
  ...
  //               queryFn: async () => {
  //                 await sleep(5)
  //                 return await Promise.resolve('first result ' + count)
  //               },
  //             },
  //             {
  //               queryKey: key2,
  //               queryFn: async () => {
  //                 await sleep(50)
  //                 return await Promise.resolve('second result ' + count)
  //               },
  //             },
  //           ],
  ...
  //             return {
  //               combined: true,
  //               refetch: () => { queryResults.forEach(async (res) => await res.refetch()); },
  //               res: queryResults
  ...
  //             {
  //               queryKey: key,
  //               queryFn: async () => await Promise.resolve('result'),
  //             },
  //           ],
  //           combine: (results) => {
  //             return {
