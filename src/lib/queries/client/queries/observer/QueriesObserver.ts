...
import { type NotifyOptions, QueryObserver } from "./QueryObserver"
...
export class QueriesObserver<TCombinedResult = QueryObserverResult[]> {
  readonly #client: QueryClient
  #result!: QueryObserverResult[]
  readonly #queries: QueryObserverOptions[]
  readonly #observers: QueryObserver[]
  readonly #options?: QueriesObserverOptions<TCombinedResult>
